...
export type GetCategoriesQuery = { __typename?: 'Query', categories: Array<{ __typename?: 'Category', id: string, title: string, slug: string }> };
...
export type GetPostBySlugQuery = { __typename?: 'Query', post?: { __typename?: 'Post', id: string, slug: string, tags: Array<string>, title: string, stage: Stage, publishedAt?: any | null, author?: { __typename?: 'Author', biography?: string | null, name: string, avatar?: { __typename?: 'Asset', url: string } | null } | null, categories: Array<{ __typename?: 'Category', id: string, title: string, slug: string }>, cover?: { __typename?: 'Asset', url: string } | null, content: { __typename?: 'RichText', html: string } } | null };
...
export type GetPostsByCategoryQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', id: string, title: string, slug: string, publishedAt?: any | null, excerpt?: string | null, cover?: { __typename?: 'Asset', url: string } | null, categories: Array<{ __typename?: 'Category', id: string, title: string, slug: string }> }> };

export type GetPostsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', id: string, title: string, slug: string, publishedAt?: any | null, excerpt?: string | null, cover?: { __typename?: 'Asset', url: string } | null, categories: Array<{ __typename?: 'Category', id: string, title: string, slug: string }> }> };
...
export type GetRelatedPostsByCategoryQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', id: string, title: string, slug: string, publishedAt?: any | null, excerpt?: string | null, cover?: { __typename?: 'Asset', url: string } | null, categories: Array<{ __typename?: 'Category', id: string, title: string, slug: string }> }> };
 ...
 * });
 */
export function useGetPostsByCategoryQuery(baseOptions?: Apollo.QueryHookOptions<GetPostsByCategoryQuery, GetPostsByCategoryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
...
export const GetRelatedPostsByCategoryDocument = gql`
...
/**
 * __useGetRelatedPostsByCategoryQuery__
 *
 * To run a query within a React component, call `useGetRelatedPostsByCategoryQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetRelatedPostsByCategoryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetRelatedPostsByCategoryQuery({
 *   variables: {
 *      slug: // value for 'slug'
 ...
 * });
 */
export function useGetRelatedPostsByCategoryQuery(baseOptions: Apollo.QueryHookOptions<GetRelatedPostsByCategoryQuery, GetRelatedPostsByCategoryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetRelatedPostsByCategoryQuery, GetRelatedPostsByCategoryQueryVariables>(GetRelatedPostsByCategoryDocument, options);
      }
export function useGetRelatedPostsByCategoryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetRelatedPostsByCategoryQuery, GetRelatedPostsByCategoryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetRelatedPostsByCategoryQuery, GetRelatedPostsByCategoryQueryVariables>(GetRelatedPostsByCategoryDocument, options);
        }
export type GetRelatedPostsByCategoryQueryHookResult = ReturnType<typeof useGetRelatedPostsByCategoryQuery>;
export type GetRelatedPostsByCategoryLazyQueryHookResult = ReturnType<typeof useGetRelatedPostsByCategoryLazyQuery>;
export type GetRelatedPostsByCategoryQueryResult = Apollo.QueryResult<GetRelatedPostsByCategoryQuery, GetRelatedPostsByCategoryQueryVariables>;